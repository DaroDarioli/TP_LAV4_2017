...
export class CrucigramaDigitalComponent implements OnInit {
  ...
  A0=new BG("A0","X");A1=new BG("A1","C");A2=new BG("A2","A");A3=new BG("A3","S");A4=new BG("A4","A");A5=new BG("A5","X");A6=new BG("A6","X");A7=new BG("A7","X");A8=new BG("A8","X");A9=new BG("A9","X");
  B0=new BG("B0","X");B1=new BG("B1","C");B2=new BG("B2","A");B3=new BG("B3","S");B4=new BG("B4","A");B5=new BG("B5","X");B6=new BG("B6","X");B7=new BG("B7","X");B8=new BG("B8","X");B9=new BG("B9","N");
  C0=new BG("C0","X");C1=new BG("C1","C");C2=new BG("C2","A");C3=new BG("C3","S");C4=new BG("C4","A");C5=new BG("C5","X");C6=new BG("C6","X");C7=new BG("C7","X");C8=new BG("C8","X");C9=new BG("C9","A");
  ...
  E0=new BG("E0","X");E1=new BG("E1","C");E2=new BG("E2","A");E3=new BG("E3","S");E4=new BG("E4","U");E5=new BG("E5","X");E6=new BG("E6","X");E7=new BG("E7","X");E8=new BG("E8","X");E9=new BG("E9","O");
  F0=new BG("F0","X");F1=new BG("F1","C");F2=new BG("F2","A");F3=new BG("F3","B");F4=new BG("F4","A");F5=new BG("F5","X");F6=new BG("F6","X");F7=new BG("F7","X");F8=new BG("F8","X");F9=new BG("F9","M");
  G0=new BG("G0","X");G1=new BG("G1","C");G2=new BG("G2","A");G3=new BG("G3","S");G4=new BG("G4","A");G5=new BG("G5","X");G6=new BG("G6","X");G7=new BG("G7","X");G8=new BG("G8","X");G9=new BG("G9","L");
  H0=new BG("H0","H");H1=new BG("H1","k");H2=new BG("H2","L");H3=new BG("H3","A");H4=new BG("H4","X");H5=new BG("H5","X");H6=new BG("H6","X");H7=new BG("H7","X");H8=new BG("H8","X");H9=new BG("H9","E");
  I0=new BG("I0","P");I1=new BG("I1","E");I2=new BG("I2","K");I3=new BG("I3","I");I4=new BG("I4","N");I5=new BG("I5","X");I6=new BG("I6","X");I7=new BG("I7","X");I8=new BG("I8","X");I9=new BG("I9","B");
  ...
  matrizRespuestas = [this.respuesta1,this.respuesta2,this.respuesta3];
